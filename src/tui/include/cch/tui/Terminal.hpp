...
public:
    ...
    [[nodiscard]] virtual support::ExpectedVoid set_scroll_margins(std::size_t top_row, std::size_t bottom_row) = 0;
    ...
    [[nodiscard]] virtual support::ExpectedVoid set_dock_cursor(std::size_t dock_row, std::size_t column) = 0;
