...
std::vector<std::string> assemble_keybinding_actions(bool clipboard_paste_available) {
    std::vector<std::string> actions{
            ...
            "app.thinking.toggle",
            "app.thinking.cycle",
            // Selector-scoped: the thinking selector matches the save-as-default
            // action through the same registry (pi's shared KeybindingsManager,
            // v0.87.1 `app.thinking.save`).
            "app.thinking.save",
