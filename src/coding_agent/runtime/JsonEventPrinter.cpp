...
[[nodiscard]] std::string bounded_utf8(std::string_view text, std::size_t max_bytes) {
    std::string safe;
...
[[nodiscard]] std::string bounded_redacted(std::string text, std::size_t max_bytes = kMaxPayloadStringBytes) {
    if (max_bytes == 0) {
        return {};
    }
