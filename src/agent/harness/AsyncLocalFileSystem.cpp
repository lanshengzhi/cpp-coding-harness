...
AsyncLocalFileSystem::AsyncLocalFileSystem(
    ...
    : impl_(std::make_shared<Impl>(
              std::move(runtime_target), std::make_shared<SyncLocalExecutionEnv>(std::move(workspace)))) {}
...
const std::filesystem::path& AsyncLocalFileSystem::workspace() const { return impl_->sync->workspace(); }
