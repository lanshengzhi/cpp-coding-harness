...
/// without Glaze in `src/support/Json.cpp` so non-serialization translation units
...
/// lives in the private serialization layer `support/JsonGlaze.hpp`.
...
/// serialization layer `support/JsonGlaze.hpp`.
