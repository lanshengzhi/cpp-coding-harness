...
// shared `util/Json.hpp` provides `JsonValue` I/O without Glaze; everything
...
// units that only touch `util::JsonValue` include `util/Json.hpp` and never
// parse Glaze. This header is private: no public `include/cch/...` header may
// include it, and Glaze must not appear in a public header.
