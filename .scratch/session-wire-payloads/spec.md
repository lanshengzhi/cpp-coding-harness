# Spec: Stop Leaking Session Wire Payloads
...
- This spec follows the repository guardrail that data is passive value state and serialization machinery stays local to implementation layers.
