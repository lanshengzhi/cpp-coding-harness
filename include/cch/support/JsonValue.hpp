...
/// Passive JSON value owned by the `cch_support` package (ADR 0039). This is
/// the unstructured cross-Owner JSON fact value; raw Glaze generic values never
/// cross Owner Interfaces (ADR 0007; ADR 0039).
struct JsonValue {
