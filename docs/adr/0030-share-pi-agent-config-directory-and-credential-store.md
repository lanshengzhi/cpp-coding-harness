...
> **Retired:** The shared-pi-directory and live-credential-interoperability clauses are superseded by [ADR 0058](0058-fix-the-product-state-root-under-xdg-in-pi-json-shapes.md).
