...
// Placeholder owned by #827. The seam contract this file inherits is
// that `write` is registered by name in the default registry and carries
// both renderer halves; #827 replaces this case with the per-tool
